...
import it.polimi.ingsw.beribinaghi.matchPackage.RMISession;
...
public class SetupRMISession implements SetupSession,RemoteSetupSession {
	...
	public GameSessionServerSide getGameSession() {
		try {
			...
			RMISession rmiSession = new RMISession((matchController.getMatch(this.matchName)).getMatch(),player);
